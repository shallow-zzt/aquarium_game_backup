...
function yxxlink() {
    window.location.href = 'http://www.shallow.site/aqbot/';
}
...
function shareText(score) {
	...
	if (score <= 9) return '你是认真的吗……'
    if (score <= 39) return '再练练就有手感啦~'
	if (score <= 79) return '还行罢……';
    if (score <= 119) return '针不戳……';
    if (score <= 159) return '强!';
    if (score <= 199) return '您太您了!';
	if (score <= 299) return '你……不是人!!!';
    if (score > 299) return '你!在!作!弊!';
}
